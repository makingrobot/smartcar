...
public class SpeedBoard extends GraphicalView {

    private String TAG = "SpeedBoard";
    ...
    public SpeedBoard(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void addAttrInfo()
    {
        ...
        plotAttrInfo.addAttributeInfo(XEnum.Location.TOP, "速度", 0.3f, paintTB);
        ...
        plotAttrInfo.addAttributeInfo(XEnum.Location.BOTTOM,
                Float.toString(MathHelper.getInstance().round(mPercentage * 100,1)), 0.3f, paintBT);
